...
interface AppShellProps {
  activeTab: 'welcome' | 'roadmap' | 'methodology' | 'github-flow' | 'fundamentos-git' | 'code-review'
  setActiveTab: (tab: 'welcome' | 'roadmap' | 'methodology' | 'github-flow' | 'fundamentos-git' | 'code-review') => void
  children: ReactNode
}
    ...
    <div className="container">
      <header>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button
            className={`btn ${activeTab === 'code-review' ? 'btn-primary' : 'btn-secondary'}`}
      ...
      <footer>
        ...
        <div className="footer-links">
          ...
          <a href="#" className="footer-link" onClick={(e) => { e.preventDefault(); setActiveTab('code-review'); }}>Code Review</a>
        </div>
      </footer>
    </div>
  )
